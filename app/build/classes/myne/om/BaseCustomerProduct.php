...
abstract class BaseCustomerProduct extends BaseObject implements Persistent
{
    ...
    public function setIdProduct($v)
    {
        ...
        if ($this->id_product !== $v) {
            $this->id_product = $v;
            $this->modifiedColumns[] = CustomerProductPeer::ID_PRODUCT;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCustomer !== null && $this->id_customer !== $this->aCustomer->getIdCustomer()) {
            $this->aCustomer = null;
        }
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CustomerProductQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CustomerProductPeer::ID_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`id_product`';
        }

        $sql = sprintf(
            'INSERT INTO `customer_product` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CustomerProductPeer::ID_CUSTOMER)) $criteria->add(CustomerProductPeer::ID_CUSTOMER, $this->id_customer);
        if ($this->isColumnModified(CustomerProductPeer::ID_PRODUCT)) $criteria->add(CustomerProductPeer::ID_PRODUCT, $this->id_product);
    ...
    {
        return (string) $this->exportTo(CustomerProductPeer::DEFAULT_STRING_FORMAT);
    }
