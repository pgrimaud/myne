...
abstract class BaseCommentPeer
{
    ...
    const ID_REVIEW = 'comment.id_review';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdComment', 'IdReview', 'IdUser', 'Content', 'Status', 'Date', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idComment', 'idReview', 'idUser', 'content', 'status', 'date', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID_COMMENT, CommentPeer::ID_REVIEW, CommentPeer::ID_USER, CommentPeer::CONTENT, CommentPeer::STATUS, CommentPeer::DATE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_COMMENT', 'ID_REVIEW', 'ID_USER', 'CONTENT', 'STATUS', 'DATE', ),
        BasePeer::TYPE_FIELDNAME => array ('id_comment', 'id_review', 'id_user', 'content', 'status', 'date', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdComment' => 0, 'IdReview' => 1, 'IdUser' => 2, 'Content' => 3, 'Status' => 4, 'Date' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idComment' => 0, 'idReview' => 1, 'idUser' => 2, 'content' => 3, 'status' => 4, 'date' => 5, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID_COMMENT => 0, CommentPeer::ID_REVIEW => 1, CommentPeer::ID_USER => 2, CommentPeer::CONTENT => 3, CommentPeer::STATUS => 4, CommentPeer::DATE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_COMMENT' => 0, 'ID_REVIEW' => 1, 'ID_USER' => 2, 'CONTENT' => 3, 'STATUS' => 4, 'DATE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id_comment' => 0, 'id_review' => 1, 'id_user' => 2, 'content' => 3, 'status' => 4, 'date' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CommentPeer::ID_COMMENT);
            $criteria->addSelectColumn(CommentPeer::ID_REVIEW);
            $criteria->addSelectColumn(CommentPeer::ID_USER);
            $criteria->addSelectColumn(CommentPeer::CONTENT);
            $criteria->addSelectColumn(CommentPeer::STATUS);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getIdComment(), (string) $obj->getIdReview(), (string) $obj->getIdUser()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Comment) {
                $key = serialize(array((string) $value->getIdComment(), (string) $value->getIdReview(), (string) $value->getIdUser()));
    ...
    public static function doCountJoinReview(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::ID_REVIEW, ReviewPeer::ID_REVIEW, $join_behavior);
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::ID_USER, UserPeer::ID_USER, $join_behavior);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Review objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinReview(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (Review)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Review)
                $obj2->addComment($obj1);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except Review.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CommentPeer::ID_COMMENT) && $criteria->keyContainsValue(CommentPeer::ID_COMMENT) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.CommentPeer::ID_COMMENT.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CommentPeer::ID_COMMENT);
            $value = $criteria->remove(CommentPeer::ID_COMMENT);
            if ($value) {
                $selectCriteria->add(CommentPeer::ID_COMMENT, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CommentPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(CommentPeer::ID_REVIEW);
            $value = $criteria->remove(CommentPeer::ID_REVIEW);
            if ($value) {
                $selectCriteria->add(CommentPeer::ID_REVIEW, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CommentPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(CommentPeer::ID_USER);
            $value = $criteria->remove(CommentPeer::ID_USER);
            if ($value) {
                $selectCriteria->add(CommentPeer::ID_USER, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CommentPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(CommentPeer::ID_COMMENT, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(CommentPeer::ID_REVIEW, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(CommentPeer::ID_USER, $value[2]));
    ...
    public static function retrieveByPK($id_comment, $id_review, $id_user, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $id_comment, (string) $id_review, (string) $id_user));
         if (null !== ($obj = CommentPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(CommentPeer::DATABASE_NAME);
        $criteria->add(CommentPeer::ID_COMMENT, $id_comment);
        $criteria->add(CommentPeer::ID_REVIEW, $id_review);
        $criteria->add(CommentPeer::ID_USER, $id_user);
