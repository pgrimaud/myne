...
abstract class BaseCustomerPeer
{
    ...
    const API_TOKEN = 'customer.api_token';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdCustomer', 'Name', 'Email', 'Password', 'ApiToken', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCustomer', 'name', 'email', 'password', 'apiToken', ),
        BasePeer::TYPE_COLNAME => array (CustomerPeer::ID_CUSTOMER, CustomerPeer::NAME, CustomerPeer::EMAIL, CustomerPeer::PASSWORD, CustomerPeer::API_TOKEN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CUSTOMER', 'NAME', 'EMAIL', 'PASSWORD', 'API_TOKEN', ),
        BasePeer::TYPE_FIELDNAME => array ('id_customer', 'name', 'email', 'password', 'api_token', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdCustomer' => 0, 'Name' => 1, 'Email' => 2, 'Password' => 3, 'ApiToken' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCustomer' => 0, 'name' => 1, 'email' => 2, 'password' => 3, 'apiToken' => 4, ),
        BasePeer::TYPE_COLNAME => array (CustomerPeer::ID_CUSTOMER => 0, CustomerPeer::NAME => 1, CustomerPeer::EMAIL => 2, CustomerPeer::PASSWORD => 3, CustomerPeer::API_TOKEN => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CUSTOMER' => 0, 'NAME' => 1, 'EMAIL' => 2, 'PASSWORD' => 3, 'API_TOKEN' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id_customer' => 0, 'name' => 1, 'email' => 2, 'password' => 3, 'api_token' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CustomerPeer::ID_CUSTOMER);
            ...
            $criteria->addSelectColumn(CustomerPeer::API_TOKEN);
        } else {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CustomerPeer::ID_CUSTOMER) && $criteria->keyContainsValue(CustomerPeer::ID_CUSTOMER) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CustomerPeer::ID_CUSTOMER);
            $value = $criteria->remove(CustomerPeer::ID_CUSTOMER);
            if ($value) {
                $selectCriteria->add(CustomerPeer::ID_CUSTOMER, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CustomerPeer::ID_CUSTOMER, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(CustomerProductPeer::ID_CUSTOMER, $obj->getIdCustomer());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(CustomerPeer::DATABASE_NAME);
        $criteria->add(CustomerPeer::ID_CUSTOMER, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CustomerPeer::DATABASE_NAME);
            $criteria->add(CustomerPeer::ID_CUSTOMER, $pks, Criteria::IN);
