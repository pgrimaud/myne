...
abstract class BaseComment extends BaseObject implements Persistent
{
    ...
    public function setIdComment($v)
    {
        ...
        if ($this->id_comment !== $v) {
            $this->id_comment = $v;
            $this->modifiedColumns[] = CommentPeer::ID_COMMENT;
        }
    ...
    public function setIdReview($v)
    {
        ...
        if ($this->id_review !== $v) {
            $this->id_review = $v;
            $this->modifiedColumns[] = CommentPeer::ID_REVIEW;
        }
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[] = CommentPeer::ID_USER;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = CommentPeer::STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_comment = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommentPeer::ID_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_comment`';
        }
        if ($this->isColumnModified(CommentPeer::ID_REVIEW)) {
            $modifiedColumns[':p' . $index++]  = '`id_review`';
        }
        if ($this->isColumnModified(CommentPeer::ID_USER)) {
            $modifiedColumns[':p' . $index++]  = '`id_user`';
        }
        if ($this->isColumnModified(CommentPeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`content`';
        }
        if ($this->isColumnModified(CommentPeer::STATUS)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Comment'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Comment'][serialize($this->getPrimaryKey())] = true;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdComment($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentPeer::ID_COMMENT)) $criteria->add(CommentPeer::ID_COMMENT, $this->id_comment);
        if ($this->isColumnModified(CommentPeer::ID_REVIEW)) $criteria->add(CommentPeer::ID_REVIEW, $this->id_review);
        if ($this->isColumnModified(CommentPeer::ID_USER)) $criteria->add(CommentPeer::ID_USER, $this->id_user);
        if ($this->isColumnModified(CommentPeer::CONTENT)) $criteria->add(CommentPeer::CONTENT, $this->content);
        if ($this->isColumnModified(CommentPeer::STATUS)) $criteria->add(CommentPeer::STATUS, $this->status);
    ...
    {
        $criteria = new Criteria(CommentPeer::DATABASE_NAME);
        $criteria->add(CommentPeer::ID_COMMENT, $this->id_comment);
        $criteria->add(CommentPeer::ID_REVIEW, $this->id_review);
        $criteria->add(CommentPeer::ID_USER, $this->id_user);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdComment()) && (null === $this->getIdReview()) && (null === $this->getIdUser());
    }
