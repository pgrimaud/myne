...
abstract class BaseProductPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdProduct', 'EanCode', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idProduct', 'eanCode', 'name', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID_PRODUCT, ProductPeer::EAN_CODE, ProductPeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_PRODUCT', 'EAN_CODE', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id_product', 'ean_code', 'name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdProduct' => 0, 'EanCode' => 1, 'Name' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idProduct' => 0, 'eanCode' => 1, 'name' => 2, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID_PRODUCT => 0, ProductPeer::EAN_CODE => 1, ProductPeer::NAME => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_PRODUCT' => 0, 'EAN_CODE' => 1, 'NAME' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id_product' => 0, 'ean_code' => 1, 'name' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
