...
abstract class BaseUserPeer
{
    ...
    /** the column name for the id_facebook field */
    const ID_FACEBOOK = 'user.id_facebook';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdUser', 'IdFacebook', 'FirstName', 'LastName', 'Email', 'Publication', 'Status', 'Date', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idUser', 'idFacebook', 'firstName', 'lastName', 'email', 'publication', 'status', 'date', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID_USER, UserPeer::ID_FACEBOOK, UserPeer::FIRST_NAME, UserPeer::LAST_NAME, UserPeer::EMAIL, UserPeer::PUBLICATION, UserPeer::STATUS, UserPeer::DATE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_USER', 'ID_FACEBOOK', 'FIRST_NAME', 'LAST_NAME', 'EMAIL', 'PUBLICATION', 'STATUS', 'DATE', ),
        BasePeer::TYPE_FIELDNAME => array ('id_user', 'id_facebook', 'first_name', 'last_name', 'email', 'publication', 'status', 'date', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdUser' => 0, 'IdFacebook' => 1, 'FirstName' => 2, 'LastName' => 3, 'Email' => 4, 'Publication' => 5, 'Status' => 6, 'Date' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idUser' => 0, 'idFacebook' => 1, 'firstName' => 2, 'lastName' => 3, 'email' => 4, 'publication' => 5, 'status' => 6, 'date' => 7, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID_USER => 0, UserPeer::ID_FACEBOOK => 1, UserPeer::FIRST_NAME => 2, UserPeer::LAST_NAME => 3, UserPeer::EMAIL => 4, UserPeer::PUBLICATION => 5, UserPeer::STATUS => 6, UserPeer::DATE => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_USER' => 0, 'ID_FACEBOOK' => 1, 'FIRST_NAME' => 2, 'LAST_NAME' => 3, 'EMAIL' => 4, 'PUBLICATION' => 5, 'STATUS' => 6, 'DATE' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id_user' => 0, 'id_facebook' => 1, 'first_name' => 2, 'last_name' => 3, 'email' => 4, 'publication' => 5, 'status' => 6, 'date' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserPeer::ID_USER);
            $criteria->addSelectColumn(UserPeer::ID_FACEBOOK);
            $criteria->addSelectColumn(UserPeer::FIRST_NAME);
            $criteria->addSelectColumn(UserPeer::LAST_NAME);
            $criteria->addSelectColumn(UserPeer::EMAIL);
            $criteria->addSelectColumn(UserPeer::PUBLICATION);
            $criteria->addSelectColumn(UserPeer::STATUS);
            $criteria->addSelectColumn(UserPeer::DATE);
        } else {
            $criteria->addSelectColumn($alias . '.id_user');
            $criteria->addSelectColumn($alias . '.id_facebook');
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(UserPeer::ID_USER) && $criteria->keyContainsValue(UserPeer::ID_USER) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(UserPeer::ID_USER);
            $value = $criteria->remove(UserPeer::ID_USER);
            if ($value) {
                $selectCriteria->add(UserPeer::ID_USER, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UserPeer::ID_USER, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(UserPeer::DATABASE_NAME);
        $criteria->add(UserPeer::ID_USER, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(UserPeer::DATABASE_NAME);
            $criteria->add(UserPeer::ID_USER, $pks, Criteria::IN);
